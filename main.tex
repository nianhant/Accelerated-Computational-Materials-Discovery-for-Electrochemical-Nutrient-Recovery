...
% To extend the Pourbaix diagram framework to systems containing nitrogen-based ligands (e.g., \ce{NH3}, glycine and \ce{CN-}), ligand concentrations are incorporated into pH-dependent mass balance Equations~\eqref{eq:pNH3}, \eqref{eq:pGly}, and \eqref{eq:pCN}, where the concentration of the ligand is represented by pligand in Equation ~\eqref{eq:pligand}. pH and p\ce{NH3} are not independent due to the equilibrium in Equation \eqref{eq:NH3 equilibrium} \cite{Murase1999PotentialpHBaths}.

% It is assumed that the concentrations of nitrogen ligands are solely dependent on pH and not influenced by other ligands or external factors. For instance, when both \ce{NH3} and \ce{CN-} are present, their equilibrium concentrations are determined independently as functions of pH. 
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{Figures/paper/Ni-NH3-H2O_activity=1e-04_[NH3]=0.02M_[Gly]=0.005M_[CN]=0.png}
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{Figures/paper/Au-NH3-H2O_activity=1e-04_[NH3]=0.02M_[Gly]=0.005M_[CN]=0.png}
  \caption{Ni Pourbaix diagram at $[NH_3]_{initial}= 0.02M$, $[Gly]_{initial}=0.005M$. Green box indicates experimental condition at applied potential vs RHE = -2 to 2 V, pH =11.5 to 13.5}
  \label{Au Pourbaix diagram}
\end{figure}

\begin{figure}
\includegraphics[width=0.5\textwidth]{Figures/paper/Ti-NH3-H2O_activity=1e-04_[NH3]=0.02M_[Gly]=0.005M_[CN]=0.png}
  \caption{Ni Pourbaix diagram at $[NH_3]_{initial}= 0.02M$, $[Gly]_{initial}=0.005M$. Green box indicates experimental condition at applied potential vs RHE = -2 to 2 V, pH =11.5 to 13.5}
  \label{Ti Pourbaix diagram}
\end{figure}

\begin{figure}
\includegraphics[width=0.5\textwidth]{Figures/paper/Cu-NH3-H2O_activity=1e-04_[NH3]=0.02M_[Gly]=0.005M_[CN]=0.png}
  \caption{Ni Pourbaix diagram at $[NH_3]_{initial}= 0.02M$, $[Gly]_{initial}=0.005M$. Green box indicates experimental condition at applied potential vs RHE = -2 to 2 V, pH =11.5 to 13.5}
